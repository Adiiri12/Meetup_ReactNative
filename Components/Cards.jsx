...
const PostCards = () => {
    return (
        ...
        <Card.Title titleStyle = {{ fontSize : 16}} title="User_name" left={LeftContent}/>
        <Card.Content>
          <Paragraph style = {styles.textT}>Card content lknsdklndfklknlds knldlkndskln lkdkdnksf lkndfklnsdsnkld</Paragraph>
        </Card.Content>
